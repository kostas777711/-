function  [sys, x0, str, ts] = sdspfscope2(t,x,u,varargin)
%SDSPFSCOPE2 Frame- and vector-display block for the DSP Blockset.
...
% $Revision: 1.39 $  $Date: 2002/05/10 03:27:27 $


% Syntax:
%
%   sdspfscope2(t,x,u,flag,params);
%
...
% Set Callback functions for the block (comment out when set up)
%SetBlockCallbacks(mfilename,blk);
%SetParentCallbacks(blk);
...
case {2,1,3},
    % Comms Processing.
    parent = get_param(sfcn_blk,'Parent');
